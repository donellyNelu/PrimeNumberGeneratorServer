...
public class SieveGeneratorTest {
    private SieveGenerator sieveGenerator = new SieveGenerator();
    ...
    public void generate() throws Exception {
        ...
        ArrayList<Integer> actual = sieveGenerator.generatePrime(1, 20);
    ...
    public void generate2()throws Exception{
        ...
        ArrayList<Integer> actual = sieveGenerator.generatePrime(2361, 2533);
    ...
    public void generate3()throws Exception{
        ...
        ArrayList<Integer> actual = sieveGenerator.generatePrime(-10,10);
    ...
    public void generate4()throws Exception{
        ...
        ArrayList<Integer> actual = sieveGenerator.generatePrime(-20,0);
